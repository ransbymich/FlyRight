...
urlpatterns = [
    ...
    path('get_clearance_by_clearance_id/', ClearanceViews.get_clearance_by_clearance_id,
         name='get clearance by clearance_id'),
    path('get_clearance_by_created_by/', ClearanceViews.get_clearance_by_created_by,
         name='get clearance by created by'),
